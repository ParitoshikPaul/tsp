...
================================================= */
	...
	if ( have_posts() ) :
		$layout = get_theme_mod( 'skin_archive_layout', 'masonry-3' );
		$layout_type = 'masonry';
		$sidebar = 'no-sidebar';
					...
					<tr>
						...
						<td>
							<div class="content-pad">
								<h3><?php esc_html_e( 'Archive', 'skin' ); ?></h3>
			...
			<main id="main" <?php skin_main_class(); ?>>			
				<div id="posts-list" <?php skin_posts_list_class(); ?>><?php 			
					...
					// Check if the Popout special box is activated and get its positions
						$s_popout		= get_theme_mod( 'skin_specials_popout_on', false ) && get_theme_mod( 'skin_archive_specials_popout', false );
					...
					// Check if the Image special boxes are activated and get the position for each:
						$s_image_1 = get_theme_mod( 'skin_specials_bnnr_on', false ) &&
							...
							get_theme_mod( 'skin_archive_specials_bnnr_1' );
						...
						$s_image_2 = get_theme_mod( 'skin_specials_bnnr_on', false ) &&
							...
							get_theme_mod( 'skin_archive_specials_bnnr_2' );
						...
						$s_image_3 = get_theme_mod( 'skin_specials_bnnr_on', false ) &&
							...
							get_theme_mod( 'skin_archive_specials_bnnr_3' );
						...
						$s_image_4 = get_theme_mod( 'skin_specials_bnnr_on', false ) &&
							...
							get_theme_mod( 'skin_archive_specials_bnnr_4' );
						...
						$s_image_5 = get_theme_mod( 'skin_specials_bnnr_on', false ) &&
							...
							get_theme_mod( 'skin_archive_specials_bnnr_5' );
					...
					// Check if the Social special box is activated and get its positions
						$s_social = get_theme_mod( 'skin_specials_social_on', false ) && get_theme_mod( 'skin_archive_specials_social', false );
					...
					// Check if the Popular/Latest Posts box is activated and get its positions
						$s_topposts = get_theme_mod( 'skin_specials_topposts_on', false ) && get_theme_mod( 'skin_archive_specials_topposts', false );
